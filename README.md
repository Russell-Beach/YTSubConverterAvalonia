...
I made this mostly for fun and to learn about using YTSubConverter.Shared for use in a different project, but figured it
...
<sup>1</sup> Drag & Drop is only supported on Windows, not on Linux/macOS due to limitations in Avalonia's drag & drop
